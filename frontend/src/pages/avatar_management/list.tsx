...
const AvatarManagementView = () => {
  ...
  const initFilters1 = () => {
    setFilters1({
      ...
      'shortCode': { value: null, matchMode: FilterMatchMode.STARTS_WITH, operator: FilterOperator.AND, constraints: [{ value: null, matchMode: FilterMatchMode.STARTS_WITH }] },
    });
  ...
  return (
    <AuthLayout>
      <div className="d-flex justify-content-between align-items-center flex-wrap grid-margin">
        <div>
          <h4 className="mb-3 mb-md-0">Avatar Management</h4>
        </div>
      </div>
      <div className="datatable-doc-demo">
        <div className="card">
          <DataTable paginator showGridlines dataKey="id" filters={filters1} filterDisplay="menu" value={avatars} rows={10} globalFilterFields={['name', 'shortCode']} header={header1} emptyMessage="No customers found." responsiveLayout="scroll">
...
export default AvatarManagementView;
